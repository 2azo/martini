                        ...
                        (t >= c
                            ? ((this._totalTime = c),
                              ...
                              0 === v &&
                                  ...
                                  (this._startTime === this._timeline._duration && (t = 0), (0 === t || 0 > y || y === n) && y !== t && ((i = !0), y > n && (r = "onReverseComplete")), (this._rawPrevTime = f = !e || t || y === t ? t : n)))
                            : 1e-7 > t
                            ? ((this._totalTime = this._time = this._cycle = 0),
                              (this.ratio = this._ease._calcEnd ? this._ease.getRatio(0) : 0),
                              (0 !== d || (0 === v && y > 0)) && ((r = "onReverseComplete"), (s = this._reversed)),
                              0 > t && ((this._active = !1), 0 === v && (this._initted || !this.vars.lazy || i) && (y >= 0 && (i = !0), (this._rawPrevTime = f = !e || t || y === t ? t : n))),
                              this._initted || (i = !0))
                ...
                return (
                    ...
                    (_.tweenTo = function (t, i) {
                        ...
                        var s,
                            r,
                            a,
                            o = { ease: 1, useFrames: this.usesFrames(), immediateRender: !1 }; 
                        for (r in i) o[r] = i[r];
                        return (
                            (o.time = this._parseTimeOrLabel(t)),
                            (s = (Math.abs(Number(o.time) - this._time) / this._timeScale || 0.001)* 0.1),
                            (a = new e(this, s, o)),
                            (o.onStart = function () {
                                a.target.paused(!0),
                        ...
                        if (t >= f)
                            this._locked || ((this._totalTime = f), (this._cycle = this._repeat)),
                                this._reversed ||
                                    ...
                                    0 === this._duration && (0 === t || 0 > y || y === r) && y !== t && this._first && ((u = !0), y > r && (_ = "onReverseComplete"))),
                                (this._rawPrevTime = this._duration || !e || t || this._rawPrevTime === t ? t : r),
                            ...
                            if (
                                ...
                                (this._time = 0),
                                (0 !== m || (0 === c && y !== r && (y > 0 || (0 > t && y >= 0)) && !this._locked)) && ((_ = "onReverseComplete"), (a = this._reversed)),
                                0 > t)
                            )
                            ...
                            0 === c && 0 > y && (u = !0),
                                ...
                                this._locked ||
                                    ...
                                    0 !== this._repeat &&
                                        ...
                                        this._time > c ? ((this._time = c), (t = c + 1e-4)) : 0 > this._time ? (this._time = t = 0) : (t = this._time)));
                    ...
                    for (l = 0; x > l; l++)
                        (f = t[b]),
                            ...
                            o
                                ...
                                : ((c = u - 0.5 * (u - _) * r), (m = u + 0.5 * (p - u) * r), (d = u - (c + m) / 2)),
                            (c += d),
                            (m += d),
                            (f.c = g = c),
        ...
        _gsScope._gsDefine(
            ...
            function (t, e) {
                ...
                var _,
                    ...
                    j = (function () {
                        var t = Y.indexOf("Android"),
                            e = N("a");
                        return (
                            (p = -1 !== Y.indexOf("Safari") && -1 === Y.indexOf("Chrome") && (-1 === t || Number(Y.substr(t + 8, 1)) > 3)),
                    ...
                    Q = (a.getStyle = function (t, e, i, s, r) {
                        var n;
                        return j || "opacity" !== e
                            ? (!s && t.style[e] ? (n = t.style[e]) : (i = i || Z(t)) ? (n = i[e] || i.getPropertyValue(e) || i.getPropertyValue(e.replace(S, "-$1").toLowerCase())) : t.currentStyle && (n = t.currentStyle[e]),
                    ...
                    K = function (t, e) {
                        var i,
                            ...
                            n = {};
                        if ((e = e || Z(t, null)))
                            if ((i = e.length)) for (; --i > -1; ) (r = e[i]), (-1 === r.indexOf("-transform") || be === r) && (n[r.replace(k, A)] = e.getPropertyValue(r));
                ...
                var ue = function (t, e, i, s) {
                    ...
                    me = (a.parseComplex = function (t, e, i, s, r, n, a, o, h, l) {
                        ...
                        var u,
                            ...
                            O = _ !== !1;
                        for (
                            (-1 !== s.indexOf(",") || -1 !== i.indexOf(",")) && ((k = k.join(" ").replace(M, ", ").split(" ")), (R = R.join(" ").replace(M, ", ").split(" ")), (A = k.length)),
                            ...
                            if (((c = k[u]), (m = R[u]), (T = parseFloat(c)), T || 0 === T)) a.appendXtra("", T, re(m, T), m.replace(g, ""), O && -1 !== m.indexOf("px"), !0);
                                ...
                                (S = "," === m.charAt(m.length - 1) ? ")," : ")"),
                                    ...
                                    w && !j && 0 === m[3]
                                        ...
                                        : (j || (w = !1),
                                          a
                                              .appendXtra(w ? "rgba(" : "rgb(", c[0], m[0] - c[0], ",", !0, !0)
                                              .appendXtra("", c[1], m[1] - c[1], ",", !0)
                                              .appendXtra("", c[2], m[2] - c[2], w ? "," : S, !0),
                                          w && ((c = 4 > c.length ? 1 : c[3]), a.appendXtra("", c, (4 > m.length ? 1 : m[3]) - c, S, !1)));
                            else if ((v = c.match(d))) {
                        ...
                        return (
                            ...
                            i || 0 === o || a.plugin
                                ? (a.l++,
                                  ...
                                  (a["xs" + a.l] = s || ""),
                                  o > 0
                                      ? ((a.data["xn" + o] = e + i), (a.rxp["xn" + o] = r), (a["xn" + o] = e), a.plugin || ((a.xfirst = new ce(a, "xn" + o, e, i, a.xfirst || a, 0, a.n, r, a.pr)), (a.xfirst.xs0 = 0)), a)
                ...
                var Te,
                    ...
                    Me = (U.getTransform = function (t, e, i, s) {
                        ...
                        if (
                            (xe
                                ? (o = Q(t, be, e, !0))
                                : t.currentStyle && ((o = t.currentStyle.filter.match(C)), (o = o && 4 === o.length ? [o[0].substr(4), Number(o[2].substr(4)), Number(o[1].substr(4)), o[3].substr(4), d.x || 0, d.y || 0].join(",") : "")),
                            ...
                            d.svg &&
                                (n && -1 !== (t.style[xe] + "").indexOf("matrix") && ((o = t.style[xe]), (n = !1)),
                            ...
                            for (h = (o || "").match(/(?:\-|\b)[\d\-\.e]+\b/gi) || [], l = h.length; --l > -1; ) (_ = Number(h[l])), (h[l] = (u = _ - (_ |= 0)) ? (0 | (u * y + (0 > u ? -0.5 : 0.5))) / y + _ : _);
                            if (16 === h.length) {
                                var x,
                                    b,
                                    P,
                    ...
                    ze = function (t) {
                        ...
                        if (p) {
                            ...
                            if (
                                (null != s.ox && ((f = (s.oxp ? 0.01 * d * s.ox : s.ox) - d / 2), (c = (s.oyp ? 0.01 * g * s.oy : s.oy) - g / 2), (x += f - (f * o + c * h)), (b += c - (f * l + c * _))),
                                v ? ((f = d / 2), (c = g / 2), (y += ", Dx=" + (f - (f * o + c * h) + x) + ", Dy=" + (c - (f * l + c * _) + b) + ")")) : (y += ", sizingMethod='auto expand')"),
                                ...
                                (0 === t || 1 === t) &&
                                    ...
                                    0 === l &&
                                    1 === _ &&
                                    ((v && -1 === y.indexOf("Dx=0, Dy=0")) || (w.test(e) && 100 !== parseFloat(RegExp.$1)) || (-1 === e.indexOf("gradient(" && e.indexOf("Alpha")) && u.removeAttribute("filter"))),
                                !v)
                            ) {
                                var P,
                                    S,
                    ...
                    Ie = (U.set3DTransformRatio = U.setTransformRatio = function (t) {
                            ...
                            return (
                                R || S.skewX || N
                                    ? ((R *= z),
                                      ...
                                      (i = Math.sin(R - b) * -D),
                                      (n = Math.cos(R - b) * D),
                                      b && "simple" === S.skewType && ((v = Math.tan(b)), (v = Math.sqrt(1 + v * v)), (i *= v), (n *= v)),
                                      N && ((I += S.xOrigin - (S.xOrigin * e + S.yOrigin * i)), (F += S.yOrigin - (S.xOrigin * r + S.yOrigin * n)), (m = 1e-6), m > I && I > -m && (I = 0), m > F && F > -m && (F = 0)),
                                      (T = (0 | (e * P)) / P + "," + (0 | (r * P)) / P + "," + (0 | (i * P)) / P + "," + (0 | (n * P)) / P + "," + I + "," + F + ")"),
                                      N && Te ? this.t.setAttribute("transform", "matrix(" + T) : (k[xe] = (S.xPercent || S.yPercent ? "translate(" + S.xPercent + "%," + S.yPercent + "%) matrix(" : "matrix(") + T))
                                    : (k[xe] = (S.xPercent || S.yPercent ? "translate(" + S.xPercent + "%," + S.yPercent + "%) matrix(" : "matrix(") + C + ",0,0," + D + "," + I + "," + F + ")"),
                                void 0
                            );
                        ...
                        (l = 1),
                            ...
                            A || O
                                ? ((T += w + (m > h && h > -m ? x : h) + w + (m > u && u > -m ? x : u) + w + (m > s && s > -m ? x : s)),
                                  (T += w + (m > a && a > -m ? x : a) + w + (m > l && l > -m ? x : l) + w + (m > p && p > -m ? x : p) + w))
                                : (T += ",0,0,0,0,1,0,"),
                ...
                (l = ke.prototype),
                            ...
                            parser: function (t, e, i, s, n, o, h) {
                                ...
                                if ("string" == typeof T.transform && xe) (u = L.style), (u[xe] = T.transform), (u.display = "block"), (u.position = "absolute"), E.body.appendChild(L), (l = Me(L, null, !1)), E.body.removeChild(L);
                                    ...
                                    "string" == typeof T.x && -1 !== T.x.indexOf("%") && ((l.x = 0), (l.xPercent = ne(T.x, d.xPercent))),
                                        ...
                                        Se &&
                                            ((l.rotationX = ae("rotationX" in T ? T.rotationX : "shortRotationX" in T ? T.shortRotationX + "_short" : d.rotationX || 0, d.rotationX, "rotationX", w)),
                                ...
                                for (
                                    Se && null != T.force3D && ((d.force3D = T.force3D), (c = !0)),
                    ...
                    ve("borderWidth", { parser: pe("borderTopWidth,borderRightWidth,borderBottomWidth,borderLeftWidth") }),
                ...
                var Le = function (t) {
                    if ((1 === t || 0 === t) && this.data._totalTime === this.data._totalDuration && "isFromStart" !== this.data.data) {
                        ...
                        else for (e = this.e.split(" ").join("").split(","), s = e.length; --s > -1; ) (i = e[s]), h[i] && (h[i].parse === o ? (r = !0) : (i = "transformOrigin" === i ? Pe : h[i].p)), Ee(a, i);
                ...
                (l = a.prototype),
                    ...
                    (l._onInitTween = function (t, e, o) {
                        ...
                        if (
                            ...
                            "string" == typeof e && ((d = b.cssText), (l = K(t, r)), (b.cssText = d + ";" + e), (l = J(t, l, K(t)).difs), !j && x.test(e) && (l.opacity = parseFloat(RegExp.$1)), (e = l), (b.cssText = d)),
                                ...
                                w = 3 === this._transformType,
                                    xe
                                        ? p &&
                                          ...
                                          c && this._addLazySet(b, "WebkitBackfaceVisibility", this._vars.WebkitBackfaceVisibility || (w ? "visible" : "hidden")))
                                        : (b.zoom = 1),
                                    m = f;
                                m && m._next;
                                ...
                                o
                                    ...
                                    : ((p = Q(t, a, r) + ""),
                                      ...
                                      "color" === a || "fill" === a || "stroke" === a || -1 !== a.indexOf("Color") || (d && P.test(f))
                                          ? (d || ((f = le(f)), (f = (f.length > 3 ? "rgba(" : "rgb(") + f.join(",") + ")")), (i = me(v, a, p, f, !0, "transparent", i, 0, n)))
                                          : !d || (-1 === f.indexOf(" ") && -1 === f.indexOf(","))
                                          ? ((l = parseFloat(p)),
                                            (c = l || 0 === l ? p.substr((l + "").length) : ""),
                                            ("" === p || "auto" === p) &&
                                                ("width" === a || "height" === a ? ((l = ie(t, a, r)), (c = "px")) : "left" === a || "top" === a ? ((l = H(t, a, r)), (c = "px")) : ((l = "opacity" !== a ? 0 : 1), (c = ""))),
                                            (g = d && "=" === f.charAt(1)),
                                            ...
                                            c !== m &&
                                                ...
                                                l &&
                                                ((l = $(t, a, l, c)),
                                                "%" === m ? ((l /= $(t, a, 100, "%") / 100), e.strictUnits !== !0 && (p = l + "%")) : "em" === m ? (l /= $(t, a, 1, "em")) : "px" !== m && ((u = $(t, a, u, m)), (m = "px")),
                                                g && (u || 0 === u) && (f = u + l + m)),
                                            g && (u += l),
                                            (!l && 0 !== l) || (!u && 0 !== u)
                                                ? void 0 !== v[a] && (f || ("NaN" != f + "" && null != f))
                                                    ? ((i = new ce(v, a, u || l || 0, 0, i, -1, a, !1, 0, p, f)), (i.xs0 = "none" !== f || ("display" !== a && -1 === a.indexOf("Style")) ? f : p))
                                                    : q("invalid " + a + " tween value: " + e[a])
                                                : ((i = new ce(v, a, l, u - l, i, 0, a, _ !== !1 && ("px" === m || "zIndex" === a), 0, p, f)), (i.xs0 = m)))
                ...
                var i,
                    ...
                    g = function (t) {
                        var e,
                            a,
                            o = k() - R;
                        o > c && (u += o - m), (R += o), (l.time = (R - u) / 1e3), (e = l.time - h), (!i || e > 0 || t === !0) && (l.frame++, (h += e + (e >= n ? 0.004 : n - e)), (a = !0)), t !== !0 && (r = s(g)), a && l.dispatchEvent(d);
                    };
                b.call(l),
                    (l.time = l.frame = 0),
                    (l.tick = function () {
                    ...
                    for (n = r.length; --n > -1; )
                        (o = r[n]) === e ||
                            ...
                            (o._timeline !== e._timeline
                                ...
                                : u >= o._startTime && o._startTime + o.totalDuration() / o._timeScale > u && (((c || !o._initted) && 2e-10 >= u - o._startTime) || (p[f++] = o)));
                    for (n = f; --n > -1; )
