    ...
    var ee =
                    ...
                    (Ie.update = function (e, r, t) {
                        if (!ye || t || e) {
                            var n,
                                ...
                                d = Ie.progress;
                            if (
                                (r && ((A = C), (C = ye ? Be() : u), be && ((ee = T), (T = k && !Ee ? k.totalProgress() : p))), ve && !p && de && !Xe && !qe && Ge && B < u + ((u - A) / (Ze() - He)) * ve && (p = 1e-4), p !== d && Ie.enabled)
                            ) {
                                if (
        ...
        (ScrollTrigger.register = function register(e) {
            if (
                !o &&
                ((Re = e || L()),
                K() && window.document && ((ze = window), (Le = document), (We = Le.documentElement), (Fe = Le.body)),
                Re && ((Ve = Re.utils.toArray), (De = Re.utils.clamp), (Ye = Re.core.suppressOverwrites || H), Re.core.globals("ScrollTrigger", ScrollTrigger), Fe))
            ) {
            ...
            for (t in e)
                (n = C.indexOf(t)),
                    ...
                    "all" === (Qe = t)
                        ...
                        : (r = ze.matchMedia(t)) &&
                          (r.matches && (o = i()),
                          ~n ? ((C[n + 1] = Z(C[n + 1], i)), (C[n + 2] = Z(C[n + 2], o))) : ((n = C.length), C.push(t, i, o), r.addListener ? r.addListener(Wa) : r.addEventListener("change", Wa)),
                          (C[n + 3] = r.matches)),
                    (Qe = 0);
            return C;
        }),
